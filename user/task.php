...
session_start();
    ...
    Date Task :<input class="form-control mb-1" type="date" name="date" required/>
    ...
    <a class="w-100 btn btn-light mb-1" href="http://todo.test/user/index.php"> Back to Your Home </a>
    ...
    $addItem = "INSERT INTO tasks VALUES('','$title','$description','$date','$priority','$status','$user_id')";
