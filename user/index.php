...
<body>
        ...
        <a class="navbar-brand" href="#">Application Todo -Task User -</a>
        ...
        echo '<div class="shadow p-3 mb-1 bg-body-tertiary rounded mt-5"> Welcome' . '  ' .$_SESSION['username'] . '</div>';
        ...
        echo '<form method="GET"> <button type ="submit" class="btn btn-danger w-100" name="logout">Logout</button></form>';
